    ...
    spec:
      template:
        spec:
          containers:
            - name: publish
              image: ghcr.io/LCOGT/sealedsecrets-cert-github-publisher:latest
              ...
              env:
                ...
                # Github authentication is done via a Github App.
                # Best practice is to create a new one, just for this application.
